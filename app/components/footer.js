      ...
      <div className="w-screen h-auto bg-black flex flex-col">
        <div className="w-screen flex flex-col lg:flex lg:flex-row">
          <div className=" w-full lg:w-1/3 p-5">
            ...
            <p className=" text-white/60">"Nutrición Deportiva para campeones. Proteínas, creatina, aminoácidos, Cooper, whey Protein, quemadores de Grasas, Mesoestetic, Cooper Pharma, l carnitine, winstrol. Pérdida de peso,."</p>
          </div>
          <div className=" w-full lg:w-1/3 p-5">
